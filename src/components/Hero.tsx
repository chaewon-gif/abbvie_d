...
function Hero() {
  return (
    <section
      className="pt-[100px] bg-heroText bg-contain bg-no-repeat lg:bg-top"
      id="home"
    >
      <div className="container mx-auto xl:px-[100px]">
        <div className="lg:flex text-center lg:text-left">
          ...
          <div className="flex-1 lg:max-w-[558px] mt-12">
            <h3 className="text-[18px] lg:text-xl font-semibold mb-2 lg:mb-[50px]">Hola! I'm</h3>
            <h2 className="text-[24px] lg:text-[32px] font-semibold text-accent mb-4 lg:mb-5">Justin Vaccaro</h2>
            ...
            <p className="mb-[35px] text-lg lg:text-xl text-center lg:text-left">
              Since creative designers often interact with creative teams, managers and clients, they need strong
